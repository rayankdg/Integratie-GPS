...
def create_driver():
    ...
    try:
        ...
        # Fallback op gewone Selenium (Selenium Manager regelt de juiste
        # chromedriver voor recente Chrome-versies die undetected niet aankan).
        print("[ChromeDriver] Falling back to standard Selenium WebDriver...")
        try:
            ...
            print("[ChromeDriver] Standard Selenium WebDriver started.")
            return driver
        except Exception as e:
            print(f"[ChromeDriver] Standard Selenium also failed: {e}")

        raise Exception(
            "[ChromeDriver] Failed to start Chrome (undetected-chromedriver and Selenium both failed).\n"
            "Update/herinstalleer Chrome of undetected-chromedriver."
        )
